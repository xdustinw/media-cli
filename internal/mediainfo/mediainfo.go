...
// HumanSize formats a byte count as e.g. "947KB", "12MB", "1.4GB". It is kept
// here for callers that already import mediainfo; the implementation lives in
// package media.
func HumanSize(n int64) string { return media.HumanSize(n) }
